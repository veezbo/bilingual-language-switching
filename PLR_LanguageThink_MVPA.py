...
if os.path.isfile(trimmedCache) and False: 
	...
	if os.path.isfile(preprocessedCache) and False: 
		...
		chunksTargets_boldDelay="chunksTargets_boldDelay3-4-LanguageThinking-Japanese_English.txt"
		boldDelay=6 #added
		stimulusWidth=4 #added
...
# run classifier
print 'learning on detrended, normalised, averaged, Japanese vs English ...',datetime.datetime.now()
...
P.savefig(os.path.join(sessionPath,'confMatrixAvTrial-LanguageThinking-Japanese_English.png'))
