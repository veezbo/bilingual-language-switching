#import mvpa.suite as M # machine learning with brain data
import mvpa
...
sessionPath = '/mnt/host/20120117zk_2'
...
if os.path.isfile(trimmedCache) and False: 
	...
	if os.path.isfile(preprocessedCache) and False: 
		...
		volAttribrutes = M.SampleAttributes(os.path.join(sessionPath,'behavioural',"chunksTargets_boldDelay4-4.txt")) # default is 3.txt.
